...
- cd my-folder
- git clone [here](https://github.com/Kaghenimbale/Todo-list-App.git)
...
This project is [MIT](https://github.com/Kaghenimbale/Todo-list-App/blob/dev/LICENSE) licensed.
